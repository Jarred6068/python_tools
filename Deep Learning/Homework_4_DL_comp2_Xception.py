...
full_model.fit(x=X_train2, y=y_train_onehot, epochs=100, batch_size = 64, validation_split=0.3,
               validation_batch_size = 64, callbacks=[callback])
...
df.to_csv('/mnt/ceph/jarredk/Assignments/Deep_Learning/F22_DL_HW4_train_test/test_pred_Xception_100epochs.csv')
