...
callback = K.callbacks.EarlyStopping(monitor="val_loss", patience=5, min_delta = 0.00001)
...
df.to_csv('/mnt/ceph/jarredk/Assignments/Deep_Learning/F22_DL_HW4_train_test/test_pred_InceptionRNV2_100epochs.csv')
